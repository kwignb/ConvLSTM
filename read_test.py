...
basepath_train = "./UCSD_Anomaly_Dataset.v1p2/UCSDped1/Test/"

# folder for train
each_train = sorted(glob.glob("{}/Test[0-9][0-9][0-9]".format(basepath_train)))
...
def load_dataset():
    ...
    return np.save("ucsd_ped1_test.npy", np.array(data).reshape((36, 200, 227, 227)))
